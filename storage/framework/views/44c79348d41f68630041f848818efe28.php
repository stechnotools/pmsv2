    ...
    <?php if(auth()->guard('web')->check()): ?>
        <?php if(Auth::user()->type == 'admin'): ?>
            ...
            <a href="#" class="btn btn-sm btn-primary mx-1" data-ajax-popup="true" data-size="md"
                data-title="<?php echo e(__('Add Company')); ?>" data-url="<?php echo e(route('user.file.import')); ?>" data-toggle="tooltip"
                title="<?php echo e(__('Import')); ?>">
                <i class="ti ti-file-import"></i>
            </a>
            <a href="#" class="btn btn-sm btn-primary" data-ajax-popup="true" data-size="md"
                data-title="<?php echo e(__('Create Company')); ?>" data-url="<?php echo e(route('users.create')); ?>" data-toggle="tooltip"
                title="<?php echo e(__('Create')); ?>">
                <i class="ti ti-plus"></i>
            </a>
        <?php elseif(isset($currentWorkspace) && $currentWorkspace->creater->id == Auth::id()): ?>
            <a href="<?php echo e(route('users_logs.index', $currentWorkspace->slug)); ?>" class="btn btn-sm btn-primary"
                data-title="<?php echo e(__('User Logs')); ?>" data-toggle="tooltip" title="<?php echo e(__('User Logs')); ?>">
                                ...
                                <div class="btn-group card-option">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-end">
                                        ...
                                        <a href="#" class="dropdown-item" data-ajax-popup="true" data-size="md"
                                            ...
                                            data-url="<?php echo e(route('users.reset.password', $user->id)); ?>"><i
                                                class="ti ti-edit"></i> <span><?php echo e(__('Reset Password')); ?></span></a>
                ...
                <?php if(auth()->guard('web')->check()): ?>
                    <?php if(Auth::user()->type == 'admin'): ?>
                        <a href="#" class="btn-addnew-project" data-ajax-popup="true" data-size="md"
                            data-title="<?php echo e(__('Create Company')); ?>" data-url="<?php echo e(route('users.create')); ?>">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\taskly\resources\views/users/index.blade.php ENDPATH**/ ?>