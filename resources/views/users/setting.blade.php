                                            ...
                                            <div class="col-sm-4">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="changeLanguage">
                                                        ...
                                                        <option value="{{ $languageCode }}" @if ($DEFAULT_LANG==$languageCode) selected @endif>
                                                            {{ $languageFullName }}
                                                        </option>
                                                        @endforeach
                                                    </select>
                                                    ...
                                                    <div class="accordion accordion-flush setting-accordion" id="payment-gateways">
                                                        ...
                                                        <div id="" class="accordion-item card">
                                                            ...
                                                            <h2 class="accordion-header" id="iyzipay">
                                                                ...
                                                                aria-expanded="false" aria-controls="collapseiyzipay">
                                                                    <span class="d-flex align-items-center">
                                                                        {{ __('Iyzipay') }}
                                                                    </span>
                                                                    <div class="d-flex align-items-center">
                                                            ...
                                                            <div id="collapseiyzipay" class="accordion-collapse collapse"
                                                                aria-labelledby="paypal"
                                                                data-bs-parent="#accordionExample">
                                                                <div class="accordion-body">
                                                                    <div
                                                        ...
                                                        <div id="" class="accordion-item card">
                                                            ...
                                                            <div id="collapseTwentysix" class="accordion-collapse collapse"
                                                                ...
                                                                <div class="accordion-body">
                                                                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 pb-4">
                                                                        <div class="row pt-2 form-group">
                                                                            <label class="pb-2" for="midtrans_mode">{{ __('Midtrans Mode') }}</label>
                                                                            <div class="col-lg-3">
                                                                                <div class="border p-3 accordion-header">
                                                                                    <div class="form-check">
                                                                                        <input type="radio" class="form-check-input input-primary " name="midtrans_mode" value="sandbox" {{ !isset($payment_detail['midtrans_mode']) || empty($payment_detail['midtrans_mode']) || $payment_detail['midtrans_mode'] == 'sandbox' ? 'checked' : '' }}>
                                                                            ...
                                                                            <div class="col-lg-3">
                                                                                <div class="border p-3 accordion-header">
                                                                                    <div class="form-check">
                                                                                        <input type="radio" class="form-check-input input-primary " name="midtrans_mode" value="live" {{ isset($payment_detail['midtrans_mode']) && $payment_detail['midtrans_mode'] == 'live' ? 'checked' : '' }}>
                                                                                        <label class="form-check-label d-block" for="">
                                                                                            <span>
                                                         ...
                                                         <div id="" class="accordion-item card">
                                                            <h2 class="accordion-header" id="headingTwentySix">
                                                                ...
                                                                aria-expanded="true" aria-controls="headingTwentySeven">
                                                                    <span class="d-flex align-items-center">
                                                                        {{ __('Xendit') }}
                                                                    </span>
                                                            ...
                                                            <div id="headingTwentySeven" class="accordion-collapse collapse"
                                                         ...
                                                         <div id="" class="accordion-item card">
                                                            <h2 class="accordion-header" id="heading_YooKassa_payment">
                                                                ...
                                                                aria-expanded="true" aria-controls="heading_YooKassa">
                                                                    <span class="d-flex align-items-center">
                                                                        {{ __('YooKassa') }}
                                                                    </span>
                                                            ...
                                                            <div id="heading_YooKassa" class="accordion-collapse collapse"
                                                                aria-labelledby="headingTwentySeven"
                                                                data-bs-parent="#accordionExample">
                                                                <div class="accordion-body">
                                                                    <div class="row pt-2">
