                      ...
                      <div class="col-xl-3 col-lg-4 col-sm-6 All {{ $project->status }}">
                                <div class="card">
                                    ...
                                    @endif
                                            ...
                                            <h5 class="mb-0">
                                             @if($project->is_active)
                                            <a href="@auth('web'){{route('projects.show',[$currentWorkspace->slug,$project->id])}}@elseauth{{route('client.projects.show',[$currentWorkspace->slug,$project->id])}}@endauth" title="{{ $project->name }}" class="">{{ $project->name }}<i class="ti ti-eye"></i></a></a>
                                            @else
