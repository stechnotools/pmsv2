                            ...
                            <div class="card-body p-3">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-auto">
                                        ...
                                        <a href="#" class="action-btn btn-danger  btn btn-sm d-inline-flex align-items-center delete-comment-file" data-url="{{route($client_keyword.'bug.comment.destroy.file',[$currentWorkspace->slug,$bug->project_id,$bug->id,$file->id])}}">
