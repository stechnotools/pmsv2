                                        ...
                                        <div class="row mt-2">
                                                ...
                                                <div class="card ">
                                                    ...
                                                    <div class="card-body">
                                                        <div class="logo-content">
                                                            <img src="{{ $logo . 'logo-light.png' . '?' . time() }}" id="dark_logo"    style="filter: drop-shadow(2px 3px 7px #011c4b);"
                                                                class="small_logo" />
                                                        </div>
                                            ...
                                            <div class="col-sm-6 col-md-4">
                                                <div class="card ">
                                                    ...
                                                    <div class="card-body">
                                                        <div class="logo-content">
                                                            <img src="{{ $logo . 'logo-dark.png' .'?' .time() }}" id="image" style="filter: drop-shadow(2px 3px 7px #011c4b);"
                                                                class="small_logo" />
                                                        </div>
                                                        <div class="choose-file mt-5 ">
                                            ...
                                            <div class="col-sm-6 col-md-4">
                                                <div class="card ">
                                                    ...
                                                    <div class="card-body">
                                                        <div class="logo-content">
                                                            <img src="{{ $logo . 'favicon.png' . '?' .time() }}" class="small_logo"
                                                                id="favicon"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6 col-md-6 col-sm-6 form-group">
                                                ...
                                                <input class="form-control" placeholder="Enter Pusher App Id"
                                                    ...
                                                    value="{{ !empty($setting['pusher_app_id'])  ? $setting['pusher_app_id'] : ''  }}" id="pusher_app_id">
                                            </div>
                                            <div class="col-lg-6 col-md-6 col-sm-6 form-group">
                                                ...
                                                <input class="form-control " placeholder="Enter Pusher App Key"
                                                    ...
                                                    value="{{ !empty($setting['pusher_app_key'])  ? $setting['pusher_app_key'] : ''  }}" id="pusher_app_key">
                                            </div>
                                            <div class="col-lg-6 col-md-6 col-sm-6 form-group">
                                                ...
                                                <input class="form-control " placeholder="Enter Pusher App Secret"
                                                    ...
                                                    value="{{ !empty($setting['pusher_app_secret'])  ? $setting['pusher_app_secret'] : ''  }}" id="pusher_app_secret">
                                            </div>
                                            <div class="col-lg-6 col-md-6 col-sm-6 form-group">
                                                ...
                                                <input class="form-control " placeholder="Enter Pusher App Cluster"
                                                    ...
                                                    value="{{ !empty($setting['pusher_app_cluster'])  ? $setting['pusher_app_cluster'] : ''  }}" id="pusher_app_cluster">
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6 col-md-6 col-sm-6 form-group">
                                                ...
                                                <input class="form-control"
                                                    ...
                                                    value="{{ !empty($setting['google_recaptcha_key'])  ? $setting['google_recaptcha_key'] : '' }}" id="google_recaptcha_key">
                                            </div>
                                            <div class="col-lg-6 col-md-6 col-sm-6 form-group">
                                                ...
                                                <input class="form-control "
                                                    ...
                                                    value="{{ !empty($setting['google_recaptcha_secret'])  ? $setting['google_recaptcha_secret'] : '' }}" id="google_recaptcha_secret">
                                            </div>
                                        </div>
                                        <div class="text-end">
                                            <input type="submit" value="{{ __('Save Changes') }}"
