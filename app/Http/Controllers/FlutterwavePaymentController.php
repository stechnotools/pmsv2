            ...
            if($invoice && !empty($invoice_data))
            {
                try
                {
                    ...
                    if(isset($response['status']) && $response['status'] == 'success')
                    {
                        ...
                        //dd($invoice_payment->order_id,$invoice_payment->invoice_id,$invoice_payment->currency,$invoice_payment->amount,$invoice_payment->payment_type,$invoice_payment->receipt,$invoice_payment->client_id);
