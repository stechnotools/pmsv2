...
Utility
{
    ...
    public static function fetchAdminPaymentSettings()
    {
        ...
        $adminSettings = [
            ...
            "meta_image" => '',
            "meta_keywords" => 'PMS SaaS',
            "meta_description" => 'PMS is a tool where you can Manage projects, work with clients, and collaborate with team members. All in one place.',
            'enable_cookie' => 'on',
    ...
    public static function replaceVariable($name = '', $content, $obj)
    {
        ...
        $arrValue['app_name'] = $setting['app_name'] ? $setting['app_name'] : 'PMS';
