    ...
    <div class="row">
        ...
        <div class="col-md-12">
            <div class="form-group">
                ...
                {{ Form::textarea('discover_description', $discover['discover_description'], ['class' => 'summernote form-control', 'placeholder' => __('Enter Description'), 'id'=>'summernote','required'=>'required']) }}
            </div>
        </div>
